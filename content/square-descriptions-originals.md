...
Naming: h3li0's product names are Portuguese places (Alvor, Aveiro, Beja, Seia, Tejo).
CornerCAD originals use an architectural family instead, so the catalog documents its own
provenance at a glance.

---

## Palisade Planter — UCL-PLA-0001
...
The **Palisade Planter** keeps it simple and lets the surface do the work — evenly spaced
vertical ribs wrapping a straight, generous form, so it reads as texture from across a room
and holds its own beside furniture rather than disappearing on a shelf.
...
## Baby Dragon — CAD-FIG-0001

### Summary

Meet your new tiny companion. This adorable baby dragon is 3D printed with fine detail, from
its expressive big eyes to its delicately textured wings, spiky crown, and clawed feet.
Standing just a couple of inches tall, he's perfect for a desk, bookshelf, D&D table, or as a
whimsical gift for any fantasy lover. 🐉
...
- **Approx. 2–2.5" tall**
- **Free-standing** — no assembly required
- **Ships securely packaged**

Whether you're building a collection or looking for a unique gift, this baby dragon brings a
...
<!-- NOTE: keyed to the Meridian VARIATION sku, not an item sku. The push script builds its
     ...
     of the five dial SKUs (-MER/-FOR/-HER/-BLO/-...) resolves to the same item. Bare CAD-CLK-0001 no
